...
# Case 1
case1 = create_case1()
sol1 = odr_fit(case1["f!"], case1["xdata"], case1["ydata"], case1["beta0"])
@test sol1.success
@test sol1.info == 1

# Case 2
case2 = create_case2()
sol2 = odr_fit(case2["f!"], case2["xdata"], case2["ydata"], case2["beta0"])
@test sol2.success
@test sol2.info == 1

# Case 3
case3 = create_case3()
sol3 = odr_fit(case3["f!"], case3["xdata"], case3["ydata"], case3["beta0"])
@test sol3.success
@test sol3.info == 1